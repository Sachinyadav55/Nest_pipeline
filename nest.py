...
if __name__ == '__main__':
    ...
    parser.add_argument('-p','--phred', type=str, help='Type of quality values',choices=['phred33','phred64'],default='phred33')
    parser.add_argument('-l','--platform', type=str, help='Type of platform used for sequencing',choice=['illumina','iontorrent','pacbio'],default='illumina')
    ...
    parser.add_argument('-s','--sample',nargs='+',type=str, help='Sample name',default=None)
    ...
    outdir = [args.outdir + '/' + sam for sam in args.sample]
